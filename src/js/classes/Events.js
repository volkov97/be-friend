define([
        ...
        /**
         * Return all blocks to their default state
         * @param $clickedButton Button, that emmited calling this function
         * @private
         */
        function _returnAllToDefaultState($clickedButton) {
        ...
        /**
         * 3 buttons: sound, fullscreen and share
         */
        ...
        /**
         * Making slick slider via slick.js
         */
        ...
        /**
         * Turn off slick, when the screen is large
         */
        ...
        /**
         * Auth -> set events on objects and buttons
         */
        ...
        events.setEventListenerOnSingleGame = function() {
            $('.startSingleGameButton').click(function(event) {
                ...
                _returnAllToDefaultState($('.startSingleGameButton')).then(function() {
        ...
        events.setEventListenerOnCreateRoom = function() {
            $('.createRoomButton').click(function(event) {
                ...
                _returnAllToDefaultState($(this)).then(function() {
        ...
        events.setEventListenerOnJoinRoom = function() {
            $('.joinRoomButton').click(function(event) {
                ...
                _returnAllToDefaultState($('.joinRoomButton')).then(function() {
        ...
        events.setEventListenerOnOnlineUsers = function() {
            $('.onlinePlayers__player').click(function(event) {
                ...
                _returnAllToDefaultState($('.onlinePlayers__player')).then(function() {
        ...
        /**
         * Events on answers in single game
         */
        ...
        /**
         * Events on answer buttons on multiplayer game
         */
